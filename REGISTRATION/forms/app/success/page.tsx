...
import { CheckCircle2, Download, Calendar, Ticket, ArrowLeft } from 'lucide-react';
...
export default function SuccessPage() {
  return (
    <div className="min-h-screen bg-[#1b1226] flex items-center justify-center px-4 py-12">
